...
st.caption("""
📦 **Data:** Retail CPG dataset with product pricing, discounts, sales & customer behavior  
🛍️ **Products:** Skincare, Makeup, Body Care (multi-category retail items)  
📊 **Includes:** Price, Markdown, Sales Before/After, Ratings, Returns, Seasonality  
""")
